...
var $;
(function ($) {
    class $hyoo_square_svg extends $mol_svg_root {
        view_box() {
            return "0 0 24 24";
        }
        style() {
        ...
        Path_lo_text() {
            const obj = new this.$.$mol_svg_path();
            obj.geometry = () => this.path("lo_text");
            return obj;
        }
        Path_lo_data() {
            const obj = new this.$.$mol_svg_path();
            obj.geometry = () => this.path("lo_data");
            return obj;
        }
        Path_hi_text() {
            const obj = new this.$.$mol_svg_path();
            obj.geometry = () => this.path("hi_text");
            return obj;
        }
        Path_hi_data() {
            const obj = new this.$.$mol_svg_path();
            obj.geometry = () => this.path("hi_data");
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $hyoo_square_svg.prototype, "bin", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_svg.prototype, "Path_lo_text", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_svg.prototype, "Path_lo_data", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_svg.prototype, "Path_hi_text", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_svg.prototype, "Path_hi_data", null);
    $.$hyoo_square_svg = $hyoo_square_svg;
})($ || ($ = {}));
//hyoo/square/svg/-view.tree/svg.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
;
var $node = $node || {} ; $node[ "/hyoo/square/svg/svg.font.png" ] = "data:image/png;base64,"
    ...
    (function ($$) {
        class $hyoo_square_svg extends $.$hyoo_square_svg {
            ...
            bits_data() {
                ...
                bits.set(bin);
                let next = 2352464411;
                const shuffle = (seed) => (((next = (next * 1103515245 + 12345) | 0) >> 14) & 0xFF) ^ seed;
                for (let i = 0; i < bits.length; ++i)
                    bits[i] = shuffle(bits[i]);
                return bits;
            }
            path(face) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_square_svg.prototype, "sizes", null);
        __decorate([
            $mol_mem
        ], $hyoo_square_svg.prototype, "view_box", null);
        __decorate([
            $mol_mem
        ], $hyoo_square_svg.prototype, "bits_data", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_square_svg.prototype, "path", null);
        __decorate([
            $mol_mem
        ], $hyoo_square_svg, "font", null);
        $$.$hyoo_square_svg = $hyoo_square_svg;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//hyoo/square/svg/svg.view.ts
;
"use strict";
var $;
(function ($) {
...
//hyoo/square/svg/svg.view.css.ts
;
"use strict";
var $;
(function ($) {
    class $hyoo_square_app extends $mol_page {
        title() {
            return "Square Code";
        }
        head() {
        ...
        Source() {
            ...
            obj.uri = () => "https://github.com/hyoo-ru/square.hyoo.ru";
            return obj;
        }
        Code() {
            const obj = new this.$.$hyoo_square_svg();
            obj.str = () => this.text();
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $hyoo_square_app.prototype, "text", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_app.prototype, "Text", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_app.prototype, "Text_scroll", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_app.prototype, "Theme", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_app.prototype, "Lights", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_app.prototype, "Source", null);
    __decorate([
        $mol_mem
    ], $hyoo_square_app.prototype, "Code", null);
    $.$hyoo_square_app = $hyoo_square_app;
})($ || ($ = {}));
//hyoo/square/app/-view.tree/app.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        class $hyoo_square_app extends $.$hyoo_square_app {
            text(next) {
                return this.$.$mol_state_arg.value('text', next) ?? '';
            }
        }
        $$.$hyoo_square_app = $hyoo_square_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//hyoo/square/app/app.view.ts
;
"use strict";
var $;
(function ($) {
...
//hyoo/square/app/app.view.css.ts
