...
declare namespace $ {
	...
	type $mol_svg_path__geometry_hyoo_square_svg_1 = $mol_type_enforce<
		ReturnType< $hyoo_square_svg['path'] >
		,
		ReturnType< $mol_svg_path['geometry'] >
	>
	type $mol_svg_path__geometry_hyoo_square_svg_2 = $mol_type_enforce<
		ReturnType< $hyoo_square_svg['path'] >
		,
		ReturnType< $mol_svg_path['geometry'] >
	>
	type $mol_svg_path__geometry_hyoo_square_svg_3 = $mol_type_enforce<
		ReturnType< $hyoo_square_svg['path'] >
		,
		ReturnType< $mol_svg_path['geometry'] >
	>
	type $mol_svg_path__geometry_hyoo_square_svg_4 = $mol_type_enforce<
		ReturnType< $hyoo_square_svg['path'] >
		,
		ReturnType< $mol_svg_path['geometry'] >
	>
...
declare namespace $.$$ {
    class $hyoo_square_svg extends $.$hyoo_square_svg {
        ...
        height(): number;
        view_box(): string;
        bits_data(): Uint8Array<ArrayBuffer>;
...
declare namespace $ {
	...
	type $mol_textarea__hint_hyoo_square_app_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value_hyoo_square_app_2 = $mol_type_enforce<
		ReturnType< $hyoo_square_app['text'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_scroll__sub_hyoo_square_app_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_scroll['sub'] >
	>
	type $mol_link_source__uri_hyoo_square_app_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	type $hyoo_square_svg__str_hyoo_square_app_5 = $mol_type_enforce<
		ReturnType< $hyoo_square_app['text'] >
		,
